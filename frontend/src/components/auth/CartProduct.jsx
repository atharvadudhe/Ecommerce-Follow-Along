...
import axios from "../../axiosConfig"; // ✅ Use custom axios instance with baseURL
...
export default function CartProduct({ _id, name, images, quantity, price }) {
  ...
  const updateQuantityVal = (quantity) => {
    axios
      .put("/api/v2/product/cartproduct/quantity", {
        email: "priya@gmail.com", // You can replace this with dynamic email if needed
        productId: _id,
        quantity,
      })
      .then((res) => {
